...
export const Footer = () => {
  return (
    <footer className="w-full mt-16 py-12 border-t border-gray-100 dark:border-gray-800 flex flex-col items-center justify-center gap-6 text-sm text-gray-600 dark:text-gray-400 print:hidden">
